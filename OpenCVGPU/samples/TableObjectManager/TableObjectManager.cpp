...
skl::gpu::TableObjectManager* createTableObjectManager(const cv::gpu::GpuMat& bg1,const cv::gpu::GpuMat& bg2);
...
int main(int argc, char* argv[]){
	...
	skl::gpu::TableObjectManager* to_manager = createTableObjectManager(bg1,bg2);
...
skl::gpu::TableObjectManager* createTableObjectManager(const cv::gpu::GpuMat& bg1,const cv::gpu::GpuMat& bg2){
	...
	return dynamic_cast<skl::gpu::TableObjectManager*>(to_manager_bb);
}
